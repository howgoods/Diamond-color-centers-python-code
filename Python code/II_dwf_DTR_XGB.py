...
if __name__ == '__main__':
    data_paths = [
        ("NV", r"D:\PY_Project\Paper1\Paper1_data\II_NV_DWF.csv"),
        ("SiV", r"D:\PY_Project\Paper1\Paper1_data\II_SiV_DWF.csv"),
        ("GeV", r"D:\PY_Project\Paper1\Paper1_data\II_GeV_DWF.csv"),
        ("SnV", r"D:\PY_Project\Paper1\Paper1_data\II_SnV_DWF.csv"),
    ]
    ...
    plt.tight_layout()
    plt.savefig(r'D:\PY_Project\Paper1\Paper1_fig\II_DTR_XGB_DWF_compare.svg', format='svg', transparent=True, bbox_inches='tight')
    plt.show()