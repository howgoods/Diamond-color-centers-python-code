...
''' 1. loading data '''
data_path_NV =r"D:\PY_Project\Paper1\Paper1_data\Shapely\MPCVD_shape_NV.csv"
data_path_SiV =r"D:\PY_Project\Paper1\Paper1_data\Shapely\MPCVD_shape_SiV.csv"
data_path_GeV =r"D:\PY_Project\Paper1\Paper1_data\Shapely\MPCVD_shape_GeV.csv"
data_path_SnV =r"D:\PY_Project\Paper1\Paper1_data\Shapely\MPCVD_shape_SnV.csv"
...
NV_PressTemp = np.around(np.array(a),3)[...,0:2]
NV_Power = np.around(np.array(a),3)[...,2]

SiV_PressTemp = np.around(np.array(b),3)[...,0:2]
SiV_Power = np.around(np.array(b),3)[...,2]

GeV_PressTemp = np.around(np.array(c),3)[...,0:2]
GeV_Power = np.around(np.array(c),3)[...,2]

SnV_PressTemp = np.around(np.array(d),3)[...,0:2]
SnV_Power = np.around(np.array(d),3)[...,2]

X = pd.DataFrame(NV_PressTemp, columns=['Pressure', 'Temperature']) 	
y = pd.DataFrame(NV_Power , columns=['Power'])

X1 = pd.DataFrame(SiV_PressTemp, columns=['Pressure', 'Temperature']) 	
y1 = pd.DataFrame(SiV_Power , columns=['Power'])

X2 = pd.DataFrame(GeV_PressTemp, columns=['Pressure', 'Temperature']) 	
y2 = pd.DataFrame(GeV_Power , columns=['Power'])

X3 = pd.DataFrame(SnV_PressTemp, columns=['Pressure', 'Temperature']) 	
y3 = pd.DataFrame(SnV_Power , columns=['Power'])
...
y_train_NV = np.around(y_train_NV,3)

model.fit(X_train1, y_train1)
y_pred1 = model.predict(X_test1)
y_train_SiV = model.predict(X_train1)
y_train_SiV = np.around(y_train_SiV,3)

model.fit(X_train2, y_train2)
y_pred2 = model.predict(X_test2)
y_train_GeV = model.predict(X_train2)
y_train_GeV = np.around(y_train_GeV,3)

model.fit(X_train3, y_train3)
y_pred3 = model.predict(X_test3)
y_train_SnV = model.predict(X_train3)
y_train_SnV = np.around(y_train_SnV,3)
...
# choose Bar, violin, and heatmap and delete the "#"
######### 1. Bar ##############
...
# plt.tight_layout()
# fig.savefig(r'D:\PY_Project\Paper1\Paper1_fig\MPCVD_ShapTree_Bar.png', transparent=True)
# plt.show()
...
# plt.tight_layout()
# fig.savefig(r'D:\PY_Project\Paper1\Paper1_fig\MPCVD_ShapTree_Violin.png', transparent=True)
# plt.show()
...
ax0.tick_params(axis='y',direction='out', width=2, labelfontfamily='Arial', labelsize = font_size, pad=4)
ax0.tick_params(axis='x',direction='out', width=2, labelfontfamily='Arial', labelsize = font_size, pad=4)
ax0.text(1.2, -0.05, r'$NV$', transform=ax0.transAxes, ha='right', fontsize=18, color='k')
...
ax1.tick_params(axis='y',direction='out', width=2, labelfontfamily='Arial', labelsize = font_size, pad=4)
ax1.tick_params(axis='x',direction='out', width=2, labelfontfamily='Arial', labelsize = font_size, pad=4)
ax1.text(1.3, -0.05, r'$SiV$', transform=ax1.transAxes, ha='right', fontsize=18, color='k')
...
ax2.tick_params(axis='y',direction='out', width=2, labelfontfamily='Arial', labelsize = font_size, pad=4)
ax2.tick_params(axis='x',direction='out', width=2, labelfontfamily='Arial', labelsize = font_size, pad=4)
ax2.text(1.2, -0.05, r'$GeV$', transform=ax2.transAxes, ha='right', fontsize=18, color='k')
...
ax3.tick_params(axis='y',direction='out', width=2, labelfontfamily='Arial', labelsize = font_size, pad=4)
ax3.tick_params(axis='x',direction='out', width=2, labelfontfamily='Arial', labelsize = font_size, pad=4)
ax3.text(1.2, -0.05, r'$SnV$', transform=ax3.transAxes, ha='right', fontsize=18, color='k')

plt.tight_layout()
fig.savefig(r'D:\PY_Project\Paper1\Paper1_data\Shapely\MPCVD_DTR_Heatmap.svg', format='svg', transparent=True, bbox_inches='tight')
plt.show()