...
def plot_colored_by_distance(y_true, y_pred, cmap='', label='', show_colorbar=False, ax=None, marker=''):
    ...
    y_true_jitter = y_true + delta
    y_pred_jitter = y_pred + delta
    ...
    # scatter drawing
    sc = ax.scatter(y_true_jitter, y_pred_jitter, c=color_value, cmap=cmap,
...
if __name__ == '__main__':
    data_paths = [
        ("NV", r"D:\PY_Project\Paper1\Paper1_data\HPHT_NV_DWF.csv"),
        ("SiV", r"D:\PY_Project\Paper1\Paper1_data\HPHT_SiV_DWF.csv"),
        ("GeV", r"D:\PY_Project\Paper1\Paper1_data\HPHT_GeV_DWF.csv"),
        ("SnV", r"D:\PY_Project\Paper1\Paper1_data\HPHT_SnV_DWF.csv"),
    ]
    ...
    plt.tight_layout()
    plt.savefig(r'D:\PY_Project\Paper1\Paper1_fig\HPHT_DTR_XGB_DWF_compare.svg', format='svg', transparent=True, bbox_inches='tight')
    plt.show()